...
class VectorStore:
    def __init__(self):
        ...
        self.metadata: list[dict] = []  # keys: source, page, format, owner, classification, chunk_id, parent_text
    ...
    def add(self, chunks: list[str], metadata: list[dict] | None = None) -> None:
        ...
        # BM25 is not incremental — rebuild over all chunks
    ...
    # Retrieval — Hybrid BM25 + FAISS with RRF fusion
    def search(
        self,
        query: str,
        top_k: int = 8,
        ...
        for idx, rrf_score in ranked:
            ...
            results.append({
                ...
                "parent_text": meta.get("parent_text"),   # Small-to-Big
                "score":       rrf_score,
